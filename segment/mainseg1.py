...
from script.predict1 import dataloaderPre, predict, postprocess
...
def save_filename(data, path):
    ...
    print(len(list_name)) # 7
    print(len(list_name[6])) # 8
...
def save_lungmask (file_name, path, path_np):
    ...
    le = len(dataloaderPre(opt.batch_size, transfms)['Negative']) # 
...
if __name__ == '__main__':
   ...
   # PREDICT POSITIVE
    ...
    # # luu ket qua inference
    # np.save('/home/trucloan/LoanDao/COVID_QU_Ex-main/visualize/FPN_DenseNet121/test/images.npy',images)
    # np.save('/home/trucloan/LoanDao/COVID_QU_Ex-main/visualize/FPN_DenseNet121/test/y_predict.npy',y_predict)

    # # save file name
    # save_filename(dataloaderPre(opt.batch_size, transfms)['Positive'], '/home/trucloan/LoanDao/COVID_QU_Ex-main/visualize/FPN_DenseNet121/test/filenamePos.txt')

    # #save lung mask
    # save_lungmask (file_name ='/home/trucloan/LoanDao/COVID_QU_Ex-main/visualize/FPN_DenseNet121/test/filenamePos.txt', path = '/home/trucloan/LoanDao/COVID_QU_Ex-main/visualize/FPN_DenseNet121/test/TestPositivePos/', path_np='/home/trucloan/LoanDao/COVID_QU_Ex-main/visualize/FPN_DenseNet121/test/y_predict.npy')
    ...
    # luu ket qua inference
    np.save('/mnt/DATA/covid19_resnet152_python-main/archive_14gb/script/segment/visualize/FPN_DenseNet121/lung_mask/EDA_Test/imagesN1.npy',images)
    np.save('/mnt/DATA/covid19_resnet152_python-main/archive_14gb/script/segment/visualize/FPN_DenseNet121/lung_mask/EDA_Test/y_predictN1.npy',y_predict)

    # save file name
    save_filename(dataloaderPre(opt.batch_size, transfms)['Negative'], '/mnt/DATA/covid19_resnet152_python-main/archive_14gb/script/segment/visualize/FPN_DenseNet121/lung_mask/EDA_Test/filenameNeg1.txt')

    # save lung mask
    save_lungmask (file_name ='/mnt/DATA/covid19_resnet152_python-main/archive_14gb/script/segment/visualize/FPN_DenseNet121/lung_mask/EDA_Test/filenameNeg1.txt', path = '/mnt/DATA/covid19_resnet152_python-main/archive_14gb/script/segment/visualize/FPN_DenseNet121/lung_mask/EDA_Test/NegativePos1/', path_np='/mnt/DATA/covid19_resnet152_python-main/archive_14gb/script/segment/visualize/FPN_DenseNet121/lung_mask/EDA_Test/y_predictN1.npy')
