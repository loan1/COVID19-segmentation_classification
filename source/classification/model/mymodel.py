...
# list_model =[models.resnet152(weights = 'ResNet152_Weights.DEFAULT'), models.vgg19_bn(weights = 'VGG19_BN_Weights.DEFAULT')]
...
# def initialize_model(model, num_classes, feature_extract):
...
def initialize_model(num_classes, feature_extract):
    ...
    modelEff = models.efficientnet_b7(weights = 'EfficientNet_B7_Weights.DEFAULT')
